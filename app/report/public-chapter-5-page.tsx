        ...
        stages={[
          {
            name: "Prompt Input",
            description:
              "The keyword set from the 809-row keyword dataset is used as the input prompt. The primary keyword and five secondary keywords are passed to the language model.",
            tools: ["Keyword Dataset"],
          },
          {
...
<MiniHeading>What This Demonstrates</MiniHeading>
      ...
      <Paragraph>
        ...
        needs to be concealed. Industry leaders use AI openly, as identified in
...
<MiniHeading>The Misallocated Energy</MiniHeading>
      ...
      <Paragraph>
        ...
        rephrasing, is directly observable in the audited
      ...
      <Paragraph>
        ...
        audited network, and what that uniformity signals to both readers
        and search systems.
      </Paragraph>
    </main>
  );
